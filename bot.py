    ...
    async def start(self):
        ...
        if FORCE_SUB_CHANNEL4:
            try:
                ...
                self.LOGGER(__name__).info("\nBot Stopped. https://t.me/world_fastest_bots for support")
                sys.exit()
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/world_fastest_bots for support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by \nhttps://t.me/world_fastest_bots")
...
| (_| (_) | |) | _|| _|| |__ | | >  <| _ \ (_) || | \__ \
 \___\___/|___/|___|_| |____|___/_/\_\___/\___/ |_| |___/
    ...
    def run(self):
        ...
        self.LOGGER(__name__).info("Bot is now running. Thanks to @World_Fastest_Bota")
        try:
            loop.run_forever()
